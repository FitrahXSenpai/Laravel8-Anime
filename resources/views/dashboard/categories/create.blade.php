...
@section('content')
    <div class="row mt-4 mb-3">
        <div class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="px-3 py-3">
                <h2 class="float-start mb-0">Dashboard &raquo; <b>Create New Category Anime</b></h2>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="px-3 py-3">
                <h3 class="text-center mb-0">CREATE NEW CATEGORY ANIME</h3>
            </div>
        </div>
    </div>
    <div class="row">
                ...
                <form action="/dashboard/categories" method="post" class="mb-5">
                    ...
                    <div class="table-responsive">
                        <table class="table" cellpadding="10" cellspacing="0">
                            ...
                            <tbody>
                                <tr>
                                    <td style="text-align: center;"><input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="Category" value="{{ old('name') }}" autofocus required>
                                    @error('name')
                    ...
                    <button type="submit" class="btn btn-dark block-btn mt-2">Create New Category</button>
                </form>
            </div>
        </div>
    </div>
