...
@section('content')
    <div class="row mt-4 mb-3">
        <div class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="px-3 py-3">
                <h2 class="float-start mb-0">Dashboard &raquo; <b>Edit Data Anime</b></h2>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="px-3 py-3">
                <h3 class="text-center mb-0">EDIT DATA ANIME</h3>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="px-3 py-3">
                <form action="/dashboard/daftar-anime/{{ $post->slug }}" method="post" enctype="multipart/form-data" class="mb-5">
                    @method('put')
                    @csrf
                    <div class="table-responsive">
                        <table class="table" cellpadding="10" cellspacing="0">
                            ...
                            <tbody>
                                <tr>
                                    <td style="text-align: center;"><input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" placeholder="Title" value="{{ old('title', $post->title) }}" autofocus required>
                                    @error('title')
                            ...
                            <tbody>
                                <tr>
                                    <td style="text-align: center;"><input type="text" name="genre" id="genre" class="form-control @error('genre') is-invalid @enderror" placeholder="Genre" value="{{ old('genre', $post->genre) }}" required>
                                    @error('genre')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    </td>
                    ...
                    <input type="hidden" name="body" id="body" class="form-control" value="{{ old('body', $post->body) }}">
